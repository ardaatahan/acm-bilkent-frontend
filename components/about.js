  ...
  <section className="text-gray-500 bg-gray-900 body-font">
    <div className="container px-5 pt-24 pb-12 mx-auto">
      ...
      <p className="leading-relaxed">
        ACM (Association for Computing Machinery ), bilgisayar mühendisliği
        bilimini bir araya getirmek için 1947’de kurulmuş ve gün geçtikçe
        büyüyerek dünya çapında tanınan bir kuruluş olmuştur. Merkezi New York
        şehrinde olan ACM, dünya genelinde çeşitli şubeleri, profesyonel
        kulüpleri, özel araştırma gruplarını ve öğrenci kollarını bünyesinde
        barındırmaktadır. ACM, Mesleki akademik yayın ve toplantı
        faaliyetlerinin yanı sıra bilgisayar bilimlerinin Nobel’i sayılan Turing
        Ödülü’nü veren kuruluş olarak da bilinir. Dünya genelini kapsayan üyelik
        sistemi ile bilişim teknolojisinin çeşitli alanları ile uğraşan
        profesyonellere ve öğrencilere kaynak sağlamaktadır.
      </p>
    </div>
    <div className="container px-5 pt-24 pb-12 mx-auto">
      <div className="flex flex-col">
